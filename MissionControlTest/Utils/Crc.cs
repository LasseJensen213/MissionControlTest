...
namespace MissionControl.Utils
{
    ...
    {
        // Based on the polynomial 0x3d65
        ...
        public static ushort Crc16(IEnumerable<byte> payload)
        {
            ushort crc = 0xFFFF; // Initial

            foreach (byte b in payload)
            {
                crc = (ushort)((crc << 8) ^ LookUp[((crc >> 8) & 0xFF) ^ b]);
            }

            return (ushort)(crc ^ 0xFFFF); // Final XOR value
